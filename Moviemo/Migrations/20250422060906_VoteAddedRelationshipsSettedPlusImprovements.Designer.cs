...
namespace Moviemo.Migrations
{
    ...
    [Migration("20250422060906_VoteAddedRelationshipsSettedPlusImprovements")]
    partial class VoteAddedRelationshipsSettedPlusImprovements
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Moviemo.Models.Vote", b =>
                {
                    b.HasOne("Moviemo.Models.Comment", null)
                        .WithMany("Votes")
                        .HasForeignKey("CommentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Moviemo.Models.Review", null)
                        .WithMany("Votes")
